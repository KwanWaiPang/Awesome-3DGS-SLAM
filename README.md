...
|:----:|:-----:| ----------- |:----------:|:----:|
|2026|`arXiv`|[LangGS-SLAM: Real-Time Language-Feature Gaussian Splatting SLAM](https://arxiv.org/pdf/2602.06991)|---|从VLM（一个语义分割模型）中嵌入三维特征场，实现开放词汇和大语言模型交互式感知；3DGS部分用的GICP|
|2026|`arXiv`|[PointSLAM++: Robust Dense Neural Gaussian Point Cloud-based SLAM](https://arxiv.org/pdf/2601.11617)|---|混合Neural（MLP）-Gaussian representation，pose优化采用GICP+ORB重投影误差融合|
...
|2025|`IROS`|[Pseudo Depth Meets Gaussian: A Feed-forward RGB SLAM Baseline](https://arxiv.org/pdf/2508.04597?)|[![Github stars](https://img.shields.io/github/stars/wangyr22/DepthGS.svg)](https://github.com/wangyr22/DepthGS)|单目深度估计模型生成伪深度图+3D高斯实现高效在线重建|
...
|2024|`CoRL`|[Event3dgs: Event-based 3d gaussian splatting for fast egomotion](https://arxiv.org/pdf/2406.02972)|[![Github stars](https://img.shields.io/github/stars/jayhsu0627/Event3DGS.svg)](https://github.com/jayhsu0627/Event3DGS)|[website](https://tyxiong23.github.io/event3dgs)|
